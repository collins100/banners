...
.to(frame3,.5, {left: 5, opacity: 1, ease:Quad.easeIn}, "-=.5")//2
.to(frame3, .8, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=2") //3
.to(frame4, 1.0, {left: 6, opacity: 1, ease: Quad.easeIn}, "-=.5") //3
.to(frame4, .8, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=2")
//.to(frame5, 1.0, {left: 10, opacity: 1, ease: Quad.easeIn}, "-=.5") //3
//.to(frame5, .8, {left: 121, opacity: 0, ease: Power2.easeOut}, "frame+=2")
...
.to(tframe7, 1.0, {left: 9, top:0,  opacity: 1, ease: Quad.easeIn},"-=1")
...
.to(logo2, 1.0, {left: 0, opacity: 1, ease: Quad.easeIn}, "end-=1.9")
    .to(disclaimerImg, 1.0, {opacity:1,left:73});
