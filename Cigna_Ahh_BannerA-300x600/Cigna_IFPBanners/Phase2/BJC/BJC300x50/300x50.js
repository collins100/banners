...
function EmarkFadeIn2() {
    	TweenLite.to(exclamationMark, 6.6, {opacity: ".25"});
...
function eventSix() {
	...
	TweenLite.to(animatedOrangeBox, 1, {y:"0", width:"205"});
...
function eventEight() {
	...
	TweenLite.to(discImg, .2, {opacity: "1",left:237, ease:Quad.easeIn, delay:1.0});
}
