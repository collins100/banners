...
tl.to(frame1, .8, {left: 221, opacity:0, ease: Power2.easeOut}, "+=1")
.to(frame2, .8, {left: 0, opacity: 1, ease:Linear.easeIn}, "-=.5")
.to(frame2, .8, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=1")//2
.to(frame3,.5, {left: 0, opacity: 1, ease:Quad.easeIn}, "-=.5")//2
.to(frame3, .8, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=1") //3
.to(frame4, 1.0, {left: 0, opacity: 1, ease: Quad.easeIn}, "-=.5") //3
.to(frame4, .8, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=1")
.to(frame5, 1.0, {left: 0, opacity: 1, ease: Quad.easeIn}, "-=.5")
.to(frame5, 1.0, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=1")
.to(frame6, 1.0, {left: 0, top:0,  opacity: 1, ease: Quad.easeIn}, "-=1.3")
.to(logo, 1.0, {top: 37, left: 0, opacity: 1, ease: Quad.easeIn}, "-=1.3")
.to(tframe6, 1.0, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=2")
.to(tframe7, 1.0, {left: 0, top:0,  opacity: 1, ease: Quad.easeIn},"-=1")
.to(tframe7, 1.0, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=2")
.to(tframe8, 1.0, {left: 0, top:0,  opacity: 1, ease: Quad.easeIn})
...
document.getElementById("disclaimerImg").addEventListener("mouseout", hideIt);