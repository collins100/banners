...
function EmarkScaleIn() {
    	TweenLite.from(exclamationMark, 5.7, {scaleX: 4, scaleY: 4, y:"0", x:"100", force3D:true,});
		}
...
function EmarkFadeIn2() {
    	TweenLite.to(exclamationMark, 6.8, {opacity: ".5"});
	    TweenLite.delayedCall(4.8, EmarkFadeIn3);
		}
function EmarkFadeIn3() {
    	TweenLite.to(exclamationMark, .5, {opacity: "1"});
		}
/**/
//////////////////////////////////////////////////
//////////BANNER FUNCTIONS
function eventOne() {
 ...
 function eventFive() {
    ...
    TweenLite.delayedCall(1.5, eventSix);
}
 function eventSix() {
 ...
 function eventSeven() {
	...
	TweenLite.to(animatedOrangeBox, .5, {y:"0", width:"497"});
	TweenLite.to(animatedDarkOrangeBox, 0, {opacity:"1"});
	TweenLite.to(animatedDarkOrangeBox, .5, {y:"20"});
	...
	TweenLite.to(disclaimer, .2, {opacity: "1", ease:Quad.easeIn});
}
