...
function eventEight() {
	...
	TweenLite.to(frame7textA, .5, {opacity: "1", ease:Quad.easeIn, delay: 1.2});
	TweenLite.from(frame7textA, 0, {x:"-300", delay:0});
	TweenLite.to(frame7textB, .5, {opacity: "1", ease:Quad.easeIn, delay: 1.2});
	...
	TweenLite.to(discImg, .2, {opacity: "1",left:237, ease:Quad.easeIn, delay:2.0});
}
