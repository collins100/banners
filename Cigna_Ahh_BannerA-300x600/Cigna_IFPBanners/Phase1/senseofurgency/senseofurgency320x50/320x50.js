...
TweenLite.to(frame2textA, 1.5, {opacity: "0", ease:Quad.easeIn});
 ...
 function eventSeven() {
     ...
     TweenLite.to(frame6textC, 1.5, {opacity: "0", ease: Quad.easeIn});
	  TweenLite.to(frame7headA, .5, {opacity: "1", ease: Quad.easeIn, delay:1.0});
	 TweenLite.from(frame7headA, 0, {x: "-300"});
	 TweenLite.to(frame7headB, .5, {opacity: "1", ease: Quad.easeIn, delay:1.0});
...
function eventEight() {
	...
	TweenLite.to(frame7headB, .5, {x:"300"});
	 TweenLite.to(frame6logo, .5, {y:"-150", delay:2.0, delay:1.0});
	 TweenLite.to(frame6logo, .5, {opacity: "0", ease:Quad.easeIn});
	TweenLite.to(frame7textA, .5, {opacity: "1", ease:Quad.easeIn, delay:1.0});
	TweenLite.from(frame7textA, 0, {x:"-300", delay:0});
	TweenLite.to(frame7textB, .5, {opacity: "1", ease:Quad.easeIn, delay:1.0});
	TweenLite.from(frame7textB, 0, {x:"-300", delay:0});
	TweenLite.to(animatedOrangeBox, .5, {y:"0", width:"140"});
