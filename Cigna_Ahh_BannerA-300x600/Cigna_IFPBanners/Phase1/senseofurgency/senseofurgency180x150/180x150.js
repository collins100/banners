...
var logo = document.getElementById("exclamationMark"),
	...
	disclaimerImg = document.getElementById("discImg"),
...
function EmarkFadeIn3() {
    	TweenLite.to(exclamationMark, 3.8, {opacity: "0"});
		}
/**/
//////////////////////////////////////////////////
//////////BANNER FUNCTIONS
...
TweenLite.to(frame2textA, 1.5, {opacity: "0", ease:Quad.easeIn});
 ...
 function eventSix() {
	...
	TweenLite.to(animatedOrangeBox, 1, {y:"69", height:"81"});
 ...
 function eventSeven() {
	 ...
	 TweenLite.to(animatedOrangeBox, .5, {y: "0", height: "107"});
	 ...
	 TweenLite.to(frame7Logo, .2, {opacity: "1", ease:Quad.easeIn});
	 TweenLite.from(frame7Logo, 0, {x:"-300", delay:0});
	 TweenLite.to(CTAbutton, .2, {opacity: "1", ease:Quad.easeIn});
...
function eventEight() {
	...
	TweenLite.to(frame7headD, 1.5, {opacity: "0", ease: Quad.easeIn});
	TweenLite.to(frame7headD, 1, {x: "300"});
	...
	TweenLite.to(discImg, .2, {opacity: "1", left:72,ease:Quad.easeIn});
}
