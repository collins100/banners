...
function QmarkScaleIn() {
    	TweenLite.from(questionMark, 5.7, {scaleX: 8, scaleY: 8, y:"0", x:"130", force3D:true,});
		}
...
function eventOne() {
 ...
 function eventSix() {
	...
	TweenLite.to(animatedCyanBox, 1, {y:"125"});
 ...
 function eventSeven() {
	...
	TweenLite.to(animatedCyanBox, .5, {y:"0", height:"92", delay:.5});
	TweenLite.to(animatedBlueBox, 0, {opacity:"1", delay:1.2});
	TweenLite.to(animatedBlueBox, .5, {y:"71", delay:1.2});
