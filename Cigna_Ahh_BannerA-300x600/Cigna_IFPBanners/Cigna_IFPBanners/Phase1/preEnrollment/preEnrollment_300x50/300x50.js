...
function QmarkFadeIn2() {
    	TweenLite.to(questionMark, 6.8, {opacity: "0.25"});
...
function eventEight(){
	...
	TweenLite.to(frame7textA, .5, {opacity: "1", ease:Quad.easeIn, delay:.75});
	...
	TweenLite.to(frame7textC, .5, {opacity: "1", ease:Quad.easeIn, delay:1.25});
	TweenLite.from(frame7textC, 0, {x:"-300", delay:0});
	TweenLite.to(sideTwo, 1, {opacity: "1", left:150,ease:Quad.easeIn, delay:0.65});
}
