...
.to(frame2, .8, {left: 2, opacity: 1, ease:Linear.easeIn}, "-=.5")
.to(frame2, .8, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=2")//2
.to(frame3,.5, {left: 15, opacity: 1, ease:Quad.easeIn}, "-=.5")//2
...
.to(frame5, .8, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=2")
