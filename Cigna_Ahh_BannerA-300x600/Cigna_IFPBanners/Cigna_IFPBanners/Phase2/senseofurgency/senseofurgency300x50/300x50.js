...
var logo = document.getElementById("exclamationMark"),
	...
	function showIt(){
		...
		TweenLite.to(disclaimer,.1, {css:{autoAlpha:1}});
...
function eventOne() {
 ...
 function eventSix() {
	...
	TweenLite.to(animatedOrangeBox, 1, {y:"0", width:"198"});
...
function eventSeven() {
	...
	TweenLite.to(frame6textC, .5, {opacity: "0", ease: Quad.easeIn});
	TweenLite.to(frame7headA, .5, {opacity: "1", ease: Quad.easeIn, delay: 1});
	TweenLite.from(frame7headA, 0, {x: "-300"});
...
function eventEight() {
	TweenLite.to(frame7headA, .5, {opacity: "0", ease:Quad.easeIn});
	TweenLite.to(frame7headA, .5, {x:"300"});
	TweenLite.to(frame7headB, .5, {opacity: "0", ease:Quad.easeIn});
	TweenLite.to(frame7headB, .5, {x:"300"});
	TweenLite.to(frame6logo, .5, {y:"-150"});
	TweenLite.to(frame6logo, .75, {opacity: "0", ease:Quad.easeIn});
	TweenLite.to(frame7textA, .5, {opacity: "1", ease:Quad.easeIn, delay: 1.9});
	TweenLite.from(frame7textA, 0, {x:"-300", delay:0});
	TweenLite.to(frame7textB, .5, {opacity: "1", ease:Quad.easeIn, delay: 1.7});
	TweenLite.from(frame7textB, 0, {x:"-300", delay:0});
	TweenLite.to(animatedOrangeBox, .5, {y:"0", width:"140",delay:.5});
	TweenLite.to(frame7Logo, .2, {opacity: "1", ease:Quad.easeIn, delay:1.7});
	TweenLite.from(frame7Logo, 0, {x:"-300", delay:0});
	TweenLite.to(CTAbutton, .2, {opacity: "1", ease:Quad.easeIn, delay:1.7});
	TweenLite.from(CTAbutton, 0, {x:"300", delay:0});
	TweenLite.to(discImg, .2, {opacity: "1",left:237, ease:Quad.easeIn, delay:1.7});
}
