...
tl.to(frame1, .8, {left: 221, opacity:0, ease: Power2.easeOut}, "frame+=2")
.to(frame2, .8, {left: 10, opacity: 1, ease:Linear.easeIn}, "-=.5")
.to(frame2, .8, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=2")//2
.to(frame3,.5, {left: 11, opacity: 1, ease:Quad.easeIn}, "-=.5")//2
.to(frame3, .8, {left: 121, opacity: 0, ease: Power2.easeOut}, "+=2") //3
.to(frame4, 1.0, {left: 18, opacity: 1, ease: Quad.easeIn}, "-=.5") //3
