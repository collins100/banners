(function() {
    ...
    tl.to(womans, .2, {opacity: 1})
        .fromTo(back, .2, {top: 600}, {top: 470, width: 300, height: 130}, "-=.3")
        .to(back, .5, {top: 470, height: 85}, "+=.5")
        .from(slideBtext1, .4, {opacity: 0, left: -300})
        .to(logo, .4, {opacity: 1})
        .to(back, .3, {top: 0, height: 555}, "+=1.5")
        .to(womans, .2, {opacity: 0})
        .to(slideBtext1, .1, {opacity: 0}, '-=.6')
        ...
        .to([slideDtext1, slideDtext2, slideDtext3, slideDtext4], .3, {left: 300}, "+=1.5")
        .from(slideAtext1, .4, {opacity: 0, left: -300})
        .from(slideAtext2, .4, {opacity: 0, left: -300})
        .to([slideAtext1, slideAtext2], .4, {left: 300}, "+=1.5")
        .from(slideCtext1, .4, {opacity: 0, left: -300})
        .from(slideCtext2, .4, {opacity: 0, left: -300})
        .from(slideCtext3, .4, {opacity: 0, left: -300})
        .to([slideCtext1, slideCtext2, slideCtext3], .4, {left: 300}, "+=1.5")
        .to(back, .4, {width: 300, top: 0, height: 280})
        .to([slideDtext1, slideDtext2, slideDtext3], .1, {opacity: 0}, '-=.3')
